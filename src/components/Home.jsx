...
export default function Home() {
  ...
  return (
    <div className='bg-slate-50 p-6 w-full min-h-screen flex flex-col items-center justify-center gap-2'>
      ...
      <button onClick={handleRedirect} type='button' className="text-blue-700 px-4 py-2 rounded-md bg-blue-100 font-semibold hover:bg-blue-200 duration-300 ease-in-out">Navigate to Jobs</button>
    </div>
  );
}
